...
async function seedData() {
    ...
    if (await Admin.countDocuments({}) === 0) {
        await Admin.create({
            ...
            hashed_password: bcrypt.hashSync('Admin@J', 10),
            name: 'Master Curator',
            created_at: new Date(),
        });
    }
